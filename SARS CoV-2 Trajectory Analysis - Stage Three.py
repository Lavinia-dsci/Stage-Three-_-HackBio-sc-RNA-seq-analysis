...
## Requirement !pip freeze | grep -E "scanpy|anndata|decoupler|scvelo|scrublet" > requirements.txt
...
These ensure full reproducibility of this workflow on Colab or any Linux system.
